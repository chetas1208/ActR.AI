...
CREATE INDEX IF NOT EXISTS idx_action_cards_job_id ON action_cards(job_id);
...
CREATE INDEX IF NOT EXISTS idx_execution_runs_action_card_id ON execution_runs(action_card_id);

-- Browser automation runs (Rtrvr)
...
CREATE INDEX IF NOT EXISTS idx_browser_runs_job_id ON browser_runs(job_id);
